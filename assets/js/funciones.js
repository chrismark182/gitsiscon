...
/*		
$('#tableaceptados').on('click', 'button[id="btnaddpre"]',function(){	
...
//var total=$('td[name="preci"]').text();
 //});
	...
	//$("#btnpreciog").click(function() {
	 //$('#tableaceptados tbody tr').each(function() {
...
/*
$("#btnpreciog" ).click(function() {
	 $('#tableenproceso tbody tr').each(function() {
	var vprecio = $(this).find('input[class="precio"]').val();
	var idsoliabas = $(this).find('input[class="idsoliabas"]').val();
	...
	var psoliabas;
		...
		$(this).find('input[class="precio"]').hide();
		$(this).find('button[class="btnpreciog"]').hide();
		$(this).find('td[class="tdprecio"]').text(preciosolabas);
	  ...
	  $.ajax({
		  ...
		  success:function(result){
			  ...
			  for(var i=0; i<len; i++){
				...
				//console.log(soliabas_departotros);
				//console.log(soliabas_departotros+"1");
				...
				*/
				...
				//$('#vfile1').val(soliabas_file1);
				//$('#vfile2').val(soliabas_file1);
				//$('#vfile3').val(soliabas_file1);
...
function priceBuildTableRow(id) {
  ...
  "<tr>" +
    ...
    "<td style='width:150px;' >" + 
	"<button type='button' class='btn-floating' id='btnaddpre' onclick='AgregarPrecio(this);' name='btnaddpre_"+ id +"' data-id='" + id + "' >" + "<i class='material-icons small'>check</i></button>" +
    "</td>" + "</tr>";
