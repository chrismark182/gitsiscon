        ...
        <tbody>
                <?php foreach($results2 as $row2): ?> 
                    <tr>
						...
						<button type="button" class='btn-floating btn-small' id="btnpreciog_<?=$row2->SOLABAS_N_ID?>" name="btnpreciog" attr_idsoli_ver="<?=$row2->SOLABAS_N_ID?>" ><i class='material-icons'>check</i></button>
						<?php
						}
						?></td>
						...
						{
						?>			
						<?php if(!($session->USUARI_C_USERNAME=='USUARIOP1' or $session->USUARI_C_USERNAME=='USUARIOP2')): ?>
            ...
            <?php if($results3): ?>
                <?php foreach($results3 as $row3): ?> 
                    <tr >
						...
						<td><button class="btn btn-floating btn-small modal-trigger" href="#modal3" name="btndetcul" id="btndetcul" attr_solabas_id="<?=$row3->SOLABAS_N_ID?>" ><i class="material-icons">description</i></button></td>
                    </tr>
                <?php endforeach; ?>  
            <?php endif; ?>
        </tbody>
	...
	<div id="divdepartamento" name="" class="" >
		...
		<div class="form-group">
			...
			<td>
				...
				<?php if($session->USUARI_C_USERNAME=='USUARIOP1' or $session->USUARI_C_USERNAME=='USUARIOP2'): ?> <input class="with-gap" name="rfile" type="radio" id="rfile1" value="1"  /><?php endif; ?>
				<span>
				...
				<label style="padding:10px;">
				<?php if($session->USUARI_C_USERNAME=='USUARIOP1' or $session->USUARI_C_USERNAME=='USUARIOP2'): ?> <input class="with-gap" name="rfile" type="radio" id="rfile2" value="2"  /><?php endif; ?>
				<span>
				...
				<label style="padding:10px;">
				<?php if($session->USUARI_C_USERNAME=='USUARIOP1' or $session->USUARI_C_USERNAME=='USUARIOP2'): ?><input class="with-gap" name="rfile" type="radio" id="rfile3" value="3"  /><?php endif; ?>
				<span>
