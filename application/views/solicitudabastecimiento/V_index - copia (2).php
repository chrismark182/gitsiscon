        ...
        <tbody>
                <?php foreach($results2 as $row2): ?> 
                    <tr>
						...
						<input class="precio" type="text" id="precio" name="precio" autocomplete="off" style="width:100px;" /> <button type="button" class='btn-floating btn-small' id="btnpreciog" name="btnpreciog"><i class='material-icons'>check</i></button>
						<?php
						}
						?></td>
                        <td name="vcompletado" > <?= "% ".$row2->SOLABAS_PORCEN ?></td>
                        <td>
						<?php
						if(!empty($row2->SOLABAS_PRECIO))
						{
						?>
						<!--
						<button type="button" class="btn btn-floating btn-small" id="btnedit" name="btnedit" href="#modal2" ><i class="material-icons">edit</i></button>-->
						
						<button class="btn btn-floating btn-small modal-trigger" href="#modal2" name="btnedit" id="btnedit" attr_solabas_id="<?=$row2->SOLABAS_N_ID?>" <?php if($row2->SOLABAS_PORCEN==100) {  echo "disabled"; } ?>    ><i class="material-icons" >edit</i></button>
						<?php
						}
						else
						{
						?>
						<!--
						<button type="button" class="btn btn-floating btn-small" disabled id="btnedit" name="btnedit" href="#modal2"  ><i class="material-icons" disabled >edit</i></button>
						-->
						<?php } ?>	
...
<div id="modal1" class="modal">
    <div class="modal-content">
      <h4 id="titulosolicitud">Solicitud _______________________</h4>
